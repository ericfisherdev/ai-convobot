...
//!
//! Nothing outside this module's own tests calls `RunningThoughtStore` yet:
//! #216/#217/#219/#220 wire the trait and `SqliteRunningThoughtStore` in
//! progressively. Every method is already exercised by the unit tests
